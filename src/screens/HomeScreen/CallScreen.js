...
export default class CallScreen extends Component {
  ...
  makeOrAnswerCall() {
    ...
    console.log('xxx this.props.navigation', this.props);
    ...
    if (isOutgoingCall) {
      ...
      this.refs.stringeeCall.initAnswer(callId, (status, code, message) => {
        console.log('xxx initAnswer', callId, status, code, message);
      });
    }
  }
  ...
  _callDidChangeSignalingState = ({
    ...
    console.log('xxx callId-', callId, code, reason, sipCode, sipReason);
