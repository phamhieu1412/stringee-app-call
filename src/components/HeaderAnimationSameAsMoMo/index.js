  ...
  return (
    <View style={styles.container}>
      <Animated.ScrollView
        ...
        <ItemInScroll numberOfItem={22} />
        <ItemInScroll numberOfItem={23} />
        <ItemInScroll numberOfItem={24} />
        <ItemInScroll numberOfItem={25} />
        <ItemInScroll numberOfItem={26} />
        <ItemInScroll numberOfItem={27} />
        <ItemInScroll numberOfItem={28} />
        <ItemInScroll numberOfItem={29} />
        <ItemInScroll numberOfItem={30} />
        <ItemInScroll numberOfItem={31} />
      </Animated.ScrollView>
